...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "wasm.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "http://localhost:8000/wasm.wasm", {credentials: "same-origin"} );
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            env: {
                "__cargo_web_snippet_00a1db0a680ee4c7c1818ae1cbd88f19f9cfdb89": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){const name=($1);const batch=($2);__UGLY_DIFF_HOOK(name,batch);})());
            },
            ...
            "__cargo_web_snippet_69a801247ecb4280f1bf44a64aeb48102b002f10": function($0, $1) {
        ...
        initialize: function( instance ) {
            ...
            Module.exports.handle = function handle(requests) {
    Module.instance.exports.handle(Module.STDWEB_PRIVATE.prepare_any_arg(requests));
}
;
